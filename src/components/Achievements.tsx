        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {t.achievements.list.map((achievement, index) => {
              ...
              return (
                <div key={index} className="flex items-start space-x-6 p-8 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl hover:shadow-lg transition-shadow duration-300 group">
