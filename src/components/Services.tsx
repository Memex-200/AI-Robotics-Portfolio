          ...
          <div className="flex flex-wrap justify-center mb-12 bg-white dark:bg-gray-900 rounded-2xl p-2 shadow-lg">
            {tabs.map((tab, index) => (
              ...
              >
                ...
                <span>
                  {t.services[tab.key as keyof typeof t.services] as string}
                </span>
              </button>
            ))}
          </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {t.services.ages.map((age, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 group"
                    >
